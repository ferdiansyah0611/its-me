...
const useApp: UseBoundStore<StoreApi<useAppInterface>> = create((_set) => ({
  ...
  projects: [
    ...
    makeProject(
      ...
      [
        "https://github.com/ferdiansyah0611/clone-spotify",
        "https://clone-spotify-kappa.vercel.app",
      ],
    ),
    makeProject(
      "Blog Multi User",
    ...
    makeProject(
      ...
      ["Vue Js", "Sass"],
      [
        "https://github.com/ferdiansyah0611/my-vite-app",
        "https://practical-nobel-3c7661.netlify.app",
      ],
    ),
    makeProject(
      "Stackoverflow Clone",
      ...
      [
        "https://gitlab.com/stuckoverflow",
        "https://stuckoverflow-fe.vercel.app",
      ],
    ),
  ],
  study: [
